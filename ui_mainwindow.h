...
"border: none;"));
        ...
        gridLayout->addWidget(next_page, 10, 0, 1, 1);
...
"padding: 5px;"));
        ...
        gridLayout->addWidget(quitButton, 12, 0, 1, 1);
...
"border: none;"));
        ...
        gridLayout->addWidget(page, 8, 0, 1, 1);
...
"border: none;"));
        ...
        gridLayout->addWidget(back_page, 7, 0, 1, 1);
