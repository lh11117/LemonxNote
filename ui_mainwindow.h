...
"border: none;"));
        ...
        gridLayout->addWidget(next_page, 11, 0, 1, 1);
...
"border: none;"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/back_page.png"), QSize(), QIcon::Normal, QIcon::Off);
        back_page->setIcon(icon1);

        gridLayout->addWidget(back_page, 8, 0, 1, 1);
...
"padding: 5px;"));
        ...
        gridLayout->addWidget(quitButton, 13, 0, 1, 1);
...
"border: none;"));
        ...
        gridLayout->addWidget(page, 9, 0, 1, 1);
